...
//gehSTART - These override earlier settings ======================================
	// Submit Buttons
	// ALTERNATES
	'delete_selected_alternates'	=> 'Delete Selected Alternate(s)',

	// Submission Messages
	// ALTERNATES
	'admin_delete_members_success'		=> "%1\$s, including all history, has been deleted from the database for your guild. Alternates must be deleted separately.",
	'admin_delete_alternates_success'	=> "%1\$s removed as alternate(s) for member %2\$s.",
	...
	// ADJUSTMENTS
    'admin_add_adj_success'           => "The %1\$s adjustment of %2\$.2f for event %3\$s has been added to all guild members.",
    'admin_update_adj_success'        => "The %1\$s adjustment of %2\$.2f for event %3\$s has been updated for all guild members.",
    'admin_delete_adj_success'        => "The %1\$s adjustment of %2\$.2f for event %3\$s has been deleted from all guild members.",

    'admin_add_iadj_success'          => "The individual %1\$s adjustment of %2\$.2f for event %3\$s has been added to %4\$s.",
    'admin_update_iadj_success'       => "The individual %1\$s adjustment of %2\$.2f for event %3\$s has been updated for %4\$s.",
    'admin_delete_iadj_success'       => "The individual %1\$s adjustment of %2\$.2f for event %3\$s has been deleted from %4\$s.",

	// Log Actions
	// ALTERNATES
	'action_alternate_added'	=> 'Alternate Added',
	'action_alternate_deleted'	=> 'Alternate Deleted',

	// Verbose log entry lines
	// ALTERNATES
	'vlog_alternate_added'		=> "%1\$s converted member(s) %2\$s to be alternate(s) for member %3\$s.",
	'vlog_alternate_deleted'	=> "%1\$s removed alternate(s) %2\$s from member %3\$s.",

	// ADJUSTMENTS
    'vlog_groupadj_added'   => "%1\$s added a group adjustment of %2\$.2f points for event %3\$s.",
    'vlog_groupadj_updated' => "%1\$s updated a group adjustment of %2\$.2f points for event %3\$s.",
    'vlog_groupadj_deleted' => "%1\$s deleted a group adjustment of %2\$.2f points for event %3\$s.",

    'vlog_indivadj_added'   => "%1\$s added an individual adjustment of %2\$.2f for event %3\$s to %4\$d member(s).",
    'vlog_indivadj_updated' => "%1\$s updated an individual adjustment of %2\$.2f for event %3\$s to %4\$d member(s).",
    'vlog_indivadj_deleted' => "%1\$s deleted an individual adjustment of %2\$.2f for event %3\$s to %4\$d member(s).",

	// CT_RaidTrackerImport
