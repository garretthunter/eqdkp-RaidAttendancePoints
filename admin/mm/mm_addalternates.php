 ...
 * 
 * $Id: mm_addalternates.php,v 1.3 2006/12/16 19:27:55 garrett Exp $
 * 
 ******************************/
   ...
   function error_check()
    ...
    function display_form()
    {
        ...
        $tpl->assign_vars(array(
            // Form vars
            'F_ADD_ALTERNATES' => 'manage_members.php' . $SID . '&amp;mode=addalternates',
    ...
    function process_addalternates()
    {
        ...
        $link_list = array(
            $user->lang['add_alternates']       => 'manage_members.php' . $SID . '&amp;mode=addalternates',
