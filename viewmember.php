 ...
 *
 * $Id: viewmember.php,v 1.8 2007/01/21 02:55:11 garrett Exp $
 *
 ******************************/
...
//gehALTERNATES
    $sql = 'SELECT member_id, member_name, member_main_id, member_earned, member_level, member_spent, member_adjustment, (member_earned-member_spent+member_adjustment) AS member_current,
              member_firstraid, member_lastraid, class_name AS member_class, race_name AS member_race, member_gender
            FROM ' . MEMBERS_TABLE . ",".
                     CLASS_TABLE . ",".
                     RACE_TABLE ."
...
//gehALTERNATES
//Save portrait information
    $playerIcons = getPlayerIcons ($member['member_race'],$member['member_class'],$member['member_gender'],$member['member_level']);
//gehALTERNATES
...
//  if ($db->num_rows($member_result) > 0) {
...
//========================================================================================================
    ...
    while ( $adjustment = $db->fetch_record($adjustments_result) )
    {
        $tpl->assign_block_vars('adjustments_row', array(
            ...
            'EVENT'                   => $adjustment['adjustment_event'])
        );
    }
...
//gehALTERNATES
        'F_MEMBERS'      => 'viewmember.php'.$SID,

        'I_PORTRAIT'     => $playerIcons['portrait'],
        'I_RACE'         => $playerIcons['race'],
        'I_CLASS'        => $playerIcons['class'],
        'I_DIR'          => $playerIcons['icon_dir'],
